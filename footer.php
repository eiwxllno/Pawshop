...
<footer id="colophon" class="site-footer">
    <div class="bg-black text-white pt-5 pb-5">
        <div class="container">
            <div class="row">
    ...
    <div class="container pt-3 ">
        <div class="row d-flex align-items-center">
            <div class="col">
                <p class="mb-0">&copy; <?php bloginfo('name'); ?> <?php echo date('Y'); ?> develop by <a href="https://erwinllano.vercel.app/" target="_blank">Erwin Llano</a></p>
            </div>
